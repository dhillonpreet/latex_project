...
%
\author{\DIFdelbegin \DIFdel{Ali Danesh}\DIFdelend \DIFaddbegin \DIFadd{Gurkaranpreet Singh}\DIFaddend %
\and \DIFdelbegin \DIFdel{Mukesh Saini}\DIFdelend \DIFaddbegin \DIFadd{S.Shiva}\DIFaddend \and  \DIFdelbegin \DIFdel{Abdulmotaleb El Saddik}\DIFdelend \DIFaddbegin \DIFadd{Himanshu Parihar}\DIFaddend }%
...
The \DIFdelbegin \DIFdel{Internet has been expanding very rapidly }\DIFdelend \DIFaddbegin \DIFadd{data services has been incresing very hapzardly }\DIFaddend with time. Now, more than 2.7
...
objects [7]. \DIFdelbegin \DIFdel{They defined five }\DIFdelend \DIFaddbegin \DIFadd{We have come up with five new }\DIFaddend dimensions for proxemic interaction: distance, orientation, movement, identity, and location. Every \DIFdelbegin \DIFdel{measured }\DIFdelend \DIFaddbegin \DIFadd{measureable }\DIFaddend change in any dimension can trigger an interaction. Marquardt et al. used this terminology to
...
The \DIFdelbegin \DIFdel{main purpose }\DIFdelend \DIFaddbegin \DIFadd{primary function }\DIFaddend of the proposed UI is to \DIFdelbegin \DIFdel{provide }\DIFdelend \DIFaddbegin \DIFadd{give us  }\DIFaddend an environment within the
IoT that supports the proxemic interactions for multimedia devices. The \DIFdelbegin \DIFdel{proposed system has }\DIFdelend \DIFaddbegin \DIFadd{new system has been proposed to have }\DIFaddend three main components: proxemic interaction unit (PIU), media redirection unit, and tracking engine. PIU is the central part of the system.
...
Devices are the \DIFdelbegin \DIFdel{first }\DIFdelend \DIFaddbegin \DIFadd{primary }\DIFaddend and most important \DIFdelbegin \DIFdel{objects }\DIFdelend \DIFaddbegin \DIFadd{machines }\DIFaddend in our system. Since the proposed system provides an environment for proxemic interactions, we begin by
...
following gender distribution: 53.7%DIF <  male and 46.3% female. They were engineers, employees, physicians, university students and professors, etc. with different background levels in IT; 53% of them were involved in a profession that
%DIF >  male and 46.3% female. They were engineers, employees, physicians, university students and professors, etc. with different background levels in IT; 53% of them were involved in job that
...
it recommends a new \DIFdelbegin \DIFdel{device }\DIFdelend \DIFaddbegin \DIFadd{machine }\DIFaddend to the user in order to motivate \DIFdelbegin \DIFdel{him/her }\DIFdelend \DIFaddbegin \DIFadd{them, }\DIFaddend to engage
